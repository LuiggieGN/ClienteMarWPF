...
namespace MAR.Config
{
    internal static partial class Settings
    {
        ...
        internal static string[] ClientPorts = { "80", "6246" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
         
        
        internal static string ClientEnableLog = @"0";
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"DATA246";
