...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = {}; //El primero es el default
        internal static string[] ClientPorts = { }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        internal static string ClientEnableLog = @"1"; 
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"MARGovernorCentral";
