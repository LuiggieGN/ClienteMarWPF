...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "ganafacil.ddns.net" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "6255" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
         
        
        internal static string ClientEnableLog = @"0";
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"DATA255";
