...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "laconciencia.ddns.net", "confianza2006.dynip.com" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "6027" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        ...
        internal static string DataName = @"DATA027";
