...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "buchona.ddns.net" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "6287" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        ...
        internal static string DataName = @"DATA287";
