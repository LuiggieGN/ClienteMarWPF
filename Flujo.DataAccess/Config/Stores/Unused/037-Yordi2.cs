...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "yordi2.ddns.net" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "6037" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
         
        
        internal static string ClientEnableLog = @"1";
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"DATA037";
