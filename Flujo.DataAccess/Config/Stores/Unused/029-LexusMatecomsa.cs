...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "bancalexus.ddns.net", "peluche.dynip.com" }; //El primero es el default
        internal static string[] ClientPorts = {"80","8888", "6029"}; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        ...
        internal static string DataName = @"DATA029";
