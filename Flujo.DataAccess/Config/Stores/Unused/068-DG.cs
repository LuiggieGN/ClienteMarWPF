...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "bancadg.ddns.net", "dg.dynip.com" }; //El primero es el default
        internal static string[] ClientPorts = {"80","6068"}; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        ...
        internal static string DataName = @"DATA068";
