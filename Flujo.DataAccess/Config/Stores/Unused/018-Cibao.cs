...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "bancacibao.ddns.net", "cibao.dynip.com" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "6018" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        ...
        internal static string DataName = @"DATA018";
