...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "fco.ddns.net","fco.dynip.com"}; //El primero es el default
        internal static string[] ClientPorts = {"80", "6073"}; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
         
        
        internal static string ClientEnableLog = @"1";
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"DATA073";
