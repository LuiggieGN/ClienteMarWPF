...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "eltesoro2006.dynip.com", "eltesoro.ddns.net" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "7500", "6024" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        ...
        internal static string DataName = @"DATA024";
