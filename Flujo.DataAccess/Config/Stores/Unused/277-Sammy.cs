...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "bancasammy.ddns.net" }; //El primero es el default
        internal static string[] ClientPorts = {"80","6277"}; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        internal static string ClientEnableLog = @"1";  // 0 consorcios fuera de RD y 1 para consorcios dentro de RD
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"DATA277";
