...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "rodriguezsport.ddns.net" }; //El primero es el default
        internal static string[] ClientPorts = {"80","6278"}; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        internal static string ClientEnableLog = @"0";  // 0 consorcios fuera de RD y 1 para consorcios dentro de RD
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"DATA278";
