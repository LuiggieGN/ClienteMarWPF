...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "faustojimenez.ddns.net", "faustojimenez.dynip.com" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "6129" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
        ...
        internal static string DataName = @"DATA129";
