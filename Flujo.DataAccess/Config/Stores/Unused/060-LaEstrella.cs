...
namespace MAR.Config
{
    ...
    {
        internal static string[] DNSHosts = { "bancaestrella.ddns.net", "estrella.dynip.com" }; //El primero es el default
        internal static string[] ClientPorts = { "80", "6060" }; //El primero es el default, ultimo es el backup, los demas son backwards compatibility
         
        
        internal static string ClientEnableLog = @"1";
        internal static string DBServerName = @"MAIN01";
        internal static string DataName = @"DATA060";
