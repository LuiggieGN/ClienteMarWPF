...
namespace ClienteMarWPF.UI.Modules.FlujoEfectivo.InicioControlEfectivo
{
    public class InicioControlEfectivoViewModel : BaseViewModel
    {

        public InicioControlEfectivoViewModel()
        {
