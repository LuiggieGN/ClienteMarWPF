...
{
    public class AnulacionFueraLineaLogic
    {
        public static void Anulacion(string pTicketNumero)
        {
            ...
            if (anulacionValues != null)
            {
                ...
                //Consume servicio
                var anulacion = ClienteHTTP.CallService<AnulacionResponseModel, AnulacionRequestModel>(MetodosEnum.MetodoServicio.Anulacion, p, MetodosEnum.HttpMethod.POST, 
                    autenticacion, true);
