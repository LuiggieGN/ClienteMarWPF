               ...
               //  JobManager.Initialize(new Scheduller.MyRegistry());
                if (!diaFueIniciado) 
                {
                    ...
                    var transaccion = new DataAccess.Tables.DTOs.TransaccionClienteHttp()
                    {
                        ...
                        Activo = false,
                        Autorizacion = "",
                        Comentario = "Hacienda, Solicitud de Inicio de dia",
                        Estado = "Solicitud",
                        Referencia = "InicioDiaHacienda",
                    ...
                    //Consume servicio
                    var iniciaDia = ClienteHTTP.CallService<InicioDiaReponseModel, InicioDiaRequestModel>(MetodosEnum.MetodoServicio.Inicio, p, MetodosEnum.HttpMethod.POST, autenticacion, true);
                    ...
                    {
                        transaccion.Respuesta = "Fallo la coneccion al servicio hacienda";
